...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_0i03ur9',
    'template_040k3vo',
    {
      from_name: form.name,
      to_name: 'TungDuong',
      from_email: form.email,
      to_email: 'ntungduong1011@gmail.com',
      ...
      >
        ...
        className='mt-12 flex flex-col gap-8'>
          <label className='flex flex-col'>
            ...
            className='bg-tertiary text-white py-4 px-6
            placeholder: text-secondary rounded-lg
            outlined-none border-non font-medium'/>
          </label>
          <label className='flex flex-col'>
            <span className='text-white font-medium
          ...
          outline-non w-fit text-white font-bold
